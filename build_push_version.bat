...
docker build -f Dockerfile -t command-service:%SERVICE_VERSION% .
...
docker tag command-service:%SERVICE_VERSION%  ion21/command-service:%SERVICE_VERSION%

echo Pushing the tagged image...
docker push  ion21/command-service:%SERVICE_VERSION%
